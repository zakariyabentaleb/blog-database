...
CREATE TABLE `articletags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `articletags_ibfk_1` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `articletags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2024-12-16 21:57:51
